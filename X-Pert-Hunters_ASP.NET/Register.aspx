...
<%@ Page Title="TravelExperts-Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="X_Pert_Hunters_Web_Application.WebForm1" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <p>
            <asp:Label ID="lblSuccMessage" runat="server" CssClass="auto-style6"></asp:Label>
        </p>
        <p>
            <asp:Label ID="lblError" runat="server" CssClass="auto-style5" style="color: #FF0000; font-size: x-large"></asp:Label>
        </p>
        <hr />
        ...
        <%--<div class="form-group">
            ...
            <div class="col-md-3">
                <asp:TextBox runat="server" ID="txtAgent" CssClass="form-control" />
            </div>
        </div>--%>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                ...
                <br />
                <br />
                <asp:Button ID="txtRegister" runat="server" OnClick="txtRegister_Click" Text="Register" />
                <br />
            </div>
        </div>
    </div>
